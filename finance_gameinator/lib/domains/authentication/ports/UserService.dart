    ...
    try {
      ...
      if (e.code == 'UsernameExistsException' ||
        ...
        return Result.fromError(BusinessError(
            HttpStatus.badRequest, e.message ?? e.code ?? e.toString()));
      } else {
        return Result.fromError(BusinessError(HttpStatus.internalServerError,
            'Unknown cognito client error occurred'));
      }
    } catch (e) {
      return Result.fromError(BusinessError(
          HttpStatus.internalServerError, 'Unknown client error occurred'));
    }
